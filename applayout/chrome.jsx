// =========================================================================
// Upkeeply · Admin desktop chrome (title bar, sidebar, top bar)
// =========================================================================
...
function AdminTitleBar({ campus, onCampus, theme, onTheme }) {
    ...
    <div style={{
      ...
      <div ref={ref} style={{ position: 'relative' }}>
        <div onClick={() => setOpen(!open)} style={{
          ...
          {CAMPUSES.find(c => c.id === campus).short}
        ...
        {open && (
          <div style={{
            ...
            {CAMPUSES.map(c => (
              ...
              onMouseEnter={e => { if (c.id !== campus) e.currentTarget.style.background = 'var(--bg-sunken)'; }}
              onMouseLeave={e => { if (c.id !== campus) e.currentTarget.style.background = 'transparent'; }}>
...
function AdminSidebar({ active, onNavigate, alertCount }) {
  const NavItem = ({ item }) => {
...
function AdminTopBar({ title, breadcrumb, children }) {
  return (
    <div style={{
...
Object.assign(window, { AdminTitleBar, AdminSidebar, AdminTopBar, ADMIN_NAV });
